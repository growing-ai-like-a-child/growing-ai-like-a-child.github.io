...
<div class="member-grid">
  ...
  <div class="member-card">
    ...
    <div class="member-info">
      <h3 class="member-name">Ziqiao Ma</h3>
      <div class="member-affiliation">University of Michigan</div>
    </div>
  </div>
  ...
  <div class="member-card">
    ...
    <div class="member-info">
      <h3 class="member-name">Emmy Liu</h3>
      <div class="member-affiliation">Carnegie Mellon University</div>
    </div>
  </div>
  ...
  <div class="member-card">
    ...
    <div class="member-info">
      <h3 class="member-name">Suyang Yu</h3>
  ...
  <div class="member-card">
    ...
    <div class="member-info">
      <h3 class="member-name">Icy Wang</h3>
  ...
  <div class="member-card">
    ...
    <div class="member-info">
      <h3 class="member-name">Tianwei Zhao</h3>
      <div class="member-affiliation">Johns Hopkins University</div>
    </div>
  </div>
  ...
  <div class="member-card">
    ...
    <div class="member-info">
      <h3 class="member-name">Pooyan Rahmanzadehgervi</h3>
  ...
  <div class="member-card">
    ...
    <div class="member-info">
      <h3 class="member-name">Avi Bhattacharya</h3>
      <div class="member-affiliation">University of Michigan</div>
    </div>
  </div>
